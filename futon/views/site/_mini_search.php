...
<form method="get" action="<?php echo _xls_site_url('/search/results'); ?>">
  ...
  <input type="image" id="seek" onclick="if( this.value == 'Search...' ) {this.value = '';};" name="search-button" class="search-button" src="<?=Yii::app()->baseUrl."/themes/futon/img/icon-search.gif" ?>">
</form>
