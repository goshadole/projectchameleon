...
<div id="genericcart">
    <div class="row-fluid">
        <div class="span5"><span class="cart_header"><?= Yii::t('cart','Description'); ?></span></div>
		...
		<?php foreach($model->cartItems as $item): ?>
			<div class="row-fluid remove-bottom cart-item">
			    <div class="span5">
	    ...
	    <div class="row-fluid remove-bottom">
		    ...
		    <div class="span2 offset8 cart_price"><span class="cart_label"><?= Yii::t('cart','Subtotal'); ?></span></div>
		...
		<div class="row-fluid cart-subtotal remove-bottom">
		        <div class="span2 offset8 cart_price"><span class="cart_label"><?= Yii::t('cart',"Shipping"); ?></span></div>
		        <div class="span2 cart_price"><span id="cartShipping"><?= _xls_currency($model->shipping_sell); ?></span></div>
		</div>
		<div class="row-fluid cart-shipping remove-bottom">
		        <div class="span2 offset8 cart_price"><?= Yii::t('cart',"Total"); ?></div>
		        <div class="span2 cart_price"><span id="cartTotal"><?= _xls_currency($model->total); ?></span></div>
		</div>
		<?php if($model->PromoCode): ?>
			<div class="row-fluid remove-bottom">
			     <div class="span4 offset8 promoCode"><?= Yii::t('cart',"Promo Code {code} Applied",array('{code}'=>"<strong>".$model->PromoCode."</strong>")); ?></div>
			</div>
		<?php endif; ?>
